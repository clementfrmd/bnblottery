    ...
    <div className="min-h-screen px-4 py-12" style={{ fontFamily: "'Nunito', sans-serif" }}>
      <div className="max-w-4xl mx-auto space-y-10">
        ...
        <section className="ac-card ac-card p-6">
          <h2 className="text-xl font-extrabold mb-4 flex items-center gap-2" style={{ color: "#D4A843" }}><Leaf size={24} /> Overview</h2>
          <p style={{ color: "#D4A843" }} className="leading-relaxed">
        ...
        {/* Smart Contract */}
        <section className="ac-card ac-card p-6">
          <h2 className="text-xl font-extrabold mb-4 flex items-center gap-2" style={{ color: "#D4A843" }}><Shovel size={24} /> Smart Contract</h2>
          <div className="space-y-3 text-sm">
            {[
              ...
              <div key={item.label} className="flex flex-col sm:flex-row sm:items-center gap-1">
                <span className="font-semibold w-32 shrink-0" style={{ color: "#D4A843" }}>{item.label}</span>
                {item.mono === false ? (
                  <span style={{ color: "#D4A843" }}>{item.value}</span>
                ) : (
                  <code className="break-all px-3 py-1 rounded-lg font-mono text-xs" style={{ background: "#ffe8d6", color: "#D4A843" }}>{item.value}</code>
                )}
              </div>
            ))}
          </div>
        ...
        {/* How Raffles Work */}
        <section className="ac-card ac-card p-6">
          <h2 className="text-xl font-extrabold mb-4 flex items-center gap-2" style={{ color: "#D4A843" }}><Ticket size={24} /> How Raffles Work</h2>
          <div className="space-y-4 text-sm leading-relaxed" style={{ color: "#D4A843" }}>
            {[
              ...
              <div key={step.title}>
                <h3 className="font-bold mb-1 flex items-center gap-1" style={{ color: "#D4A843" }}>{step.icon} {step.title}</h3>
                <p>{step.text}</p>
              </div>
            ))}
          </div>
        ...
        {/* Fee Structure */}
        <section className="ac-card ac-card p-6">
          <h2 className="text-xl font-extrabold mb-4 flex items-center gap-2" style={{ color: "#D4A843" }}><Star size={24} /> Fee Structure</h2>
          <div className="grid grid-cols-3 gap-4">
            <div className="text-center p-4 rounded-2xl" style={{ background: "linear-gradient(135deg, #D4A84320, #D4A84340)" }}>
              <div className="text-3xl font-extrabold" style={{ color: "#D4A843" }}>95%</div>
              <div className="text-sm mt-1 flex items-center justify-center gap-1" style={{ color: "#D4A843" }}><Trophy size={14} /> Winner</div>
            </div>
            <div className="text-center p-4 rounded-2xl" style={{ background: "linear-gradient(135deg, #F5D07620, #F5D07640)" }}>
              <div className="text-3xl font-extrabold" style={{ color: "#D4A843" }}>3%</div>
              <div className="text-sm mt-1" style={{ color: "#D4A843" }}>Platform</div>
            </div>
            <div className="text-center p-4 rounded-2xl" style={{ background: "linear-gradient(135deg, #00A86B20, #00A86B40)" }}>
              ...
              <div className="text-sm mt-1" style={{ color: "#D4A843" }}>Organizer</div>
            </div>
          </div>
        </section>
        ...
        {/* Supported Tokens */}
        <section className="ac-card ac-card p-6">
          <h2 className="text-xl font-extrabold mb-4 flex items-center gap-2" style={{ color: "#D4A843" }}><Coin size={24} /> Supported Tokens</h2>
          <div className="space-y-3">
            {[
              ...
              <div key={token.name} className="flex flex-col sm:flex-row sm:items-center gap-1 text-sm">
                <span className="font-bold w-28 shrink-0 flex items-center gap-1" style={{ color: "#D4A843" }}><Coin size={14} /> {token.name}</span>
                <code className="break-all px-3 py-1 rounded-lg font-mono text-xs" style={{ background: "#ffe8d6", color: "#D4A843" }}>{token.address}</code>
                <span className="text-xs ml-auto" style={{ color: "#D4A843", opacity: 0.6 }}>{token.decimals} decimals</span>
              </div>
            ))}
          </div>
          <p className="text-xs mt-4" style={{ color: "#D4A843", opacity: 0.6 }}>These are tokens on BNB Smart Chain mainnet.</p>
        </section>

        {/* VRF Randomness */}
        <section className="ac-card ac-card p-6">
          <h2 className="text-xl font-extrabold mb-4 flex items-center gap-2" style={{ color: "#D4A843" }}><CrystalBall size={24} /> VRF Randomness</h2>
          <p className="text-sm leading-relaxed" style={{ color: "#D4A843" }}>
            BNB Lucky Draw uses <strong style={{ color: "#D4A843" }}>Aleph Cloud VRF</strong> (Verifiable Random Function)
        ...
        {/* Key Functions */}
        <section className="ac-card ac-card p-6">
          <h2 className="text-xl font-extrabold mb-4 flex items-center gap-2" style={{ color: "#D4A843" }}><Clock size={24} /> Contract Functions</h2>
          <div className="space-y-4 text-sm">
            {[
              ...
              <div key={item.fn}>
                <code className="text-xs px-3 py-1.5 rounded-lg block font-mono break-all" style={{ background: "#ffe8d6", color: "#D4A843" }}>{item.fn}</code>
                <p className="mt-1 ml-1" style={{ color: "#D4A843" }}>{item.desc}</p>
              </div>
            ))}
          </div>
        </section>
